...
const columns = [
  { header: "RUC", accessor: "ruc", width: "w-2/12" },
  { header: "Razón Social", accessor: "razonSocial", width: "w-3/12" },
  { header: "Teléfono", accessor: "telefono", width: "w-2/12" },
  { header: "Correo", accessor: "correo", width: "w-3/12" },
  { header: "Direccion", accessor: "direccion", width: "w-3/12" },
  { header: "Representante", accessor: "Representante", width: "w-3/12" },
